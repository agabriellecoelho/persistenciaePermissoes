...
import { initDatabase, insertLocation, getLocations } from "./helpers/database";
import { loadDarkMode, saveDarkMode } from "./helpers/themestorage";
...
async function getLocation() {
  ...
  try {
    ...
    await insertLocation(coords.latitude.toString(), coords.longitude.toString());
